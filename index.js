...
(function() {
  const persons = [
    { name: 'Gonzalo Cruz', avatar: './img/pacman2.png' },
    { name: 'Jorge González', avatar: './img/pacman2.png' },
    { name: 'Sauri', avatar: './img/pacman2.png' },
    { name: 'Artur', avatar: './img/pacman2.png' },
    { name: 'Javi Rodríguez', avatar: './img/pacman2.png' },
